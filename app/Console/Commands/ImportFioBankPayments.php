...
class ImportFioBankPayments extends Command
{
    ...
    protected function processTransaction(Transaction $transaction)
    {
        ...
        if($transaction->getSenderAccountNumber() == '2501849271' && $transaction->getSenderBankCode() == '2010') return null;
        if($transaction->getSenderAccountNumber() == '2501264505' && $transaction->getSenderBankCode() == '2010') return null;
        if($transaction->getSenderAccountNumber() == '2400330446' && $transaction->getSenderBankCode() == '2010') return null;
        ...
        if(in_array($transaction->getId(), ['24078417125', '24043373655', '24009344380', '24005751672', '23994814899', '23741779038', '23641878706', '23565872767', '23049299445', '23025377085', '23024401133', '23017704617', '17694406216', '17724783278', '20807288786', '21328846473', '21360549813', '21366553593', '21378173811', '22944849327', '22987607930', '22991668367'])) return null;
