...
$LANG = array(
    ...
    'invoice' => 'Faktura',
    'client' => 'Klient',
    'invoice_date' => 'Datum vystavení a zdanitelného plnení',
    ...
    'recurring_quotes' => 'Pravidelné zálohovky',
    ...
    'quote' => 'Zálohová faktura',
    'quotes' => 'Zálohové faktury',
    'quote_number' => 'Číslo zálohové faktury',
    'quote_number_short' => 'Zálohová faktura #',
    'quote_date' => 'Datum zálohové faktury',
    'quote_total' => 'Celkem',
    'your_quote' => 'Vaše zálohové faktury',
    'total' => 'Celkem',
    'clone' => 'Duplikovat',
    'new_quote' => 'Nová zálohová faktura',
    'create_quote' => 'Vytvořit zálohovou fakturu',
    'edit_quote' => 'Upravit zálohovou fakturu',
    'archive_quote' => 'Archivovat zálohovou fakturu',
    'delete_quote' => 'Smazat zálohovou fakturu',
    'save_quote' => 'Uložit zálohovou fakturu',
    'email_quote' => 'Odeslat zálohovou fakturu emailem',
    'clone_quote' => 'Duplikovat jako zálohovou fakturu',
    'convert_to_invoice' => 'Změnit na fakturu',
    'view_invoice' => 'Zobrazit fakturu',
    'view_client' => 'Zobrazit klienta',
    'view_quote' => 'Zobrazit zálohovou fakturu',
    'updated_quote' => 'Zálohová faktura úspěšně aktualizována',
    'created_quote' => 'Zálohová faktura úspěšně vytvořena',
    'cloned_quote' => 'Zálohová faktura úspěšně zduplikována',
    'emailed_quote' => 'Zálohová faktura úspěšně odeslána',
    'archived_quote' => 'Zálohová faktura úspěšně archivována',
    'archived_quotes' => ':count nabídek bylo úspěšně archivováno',
    'deleted_quote' => 'Zálohová faktura úspěšně smazána',
    'deleted_quotes' => ':count nabídek bylo úspěšně smazáno',
    'converted_to_invoice' => 'Zálohová faktura byla úspěšně změněna na fakturu',
    'quote_subject' => 'Nová zálohová faktura :number od :account',
    'quote_message' => 'Pro zobrazení zálohové faktury za :amount, klikněte na odkaz níže.',
    'quote_link_message' => 'Pro zobrazení zálohové faktury vašeho klienta klikněte na odkaz níže:',
    'notification_quote_sent_subject' => 'Zálohová faktura :invoice byla odeslána klientovi :client',
    'notification_quote_viewed_subject' => 'Zálohová faktura :invoice byla zobrazena klientem :client',
    'notification_quote_sent' => 'Klientovi :client byla emailem odeslána zálohová faktura :invoice za :amount.',
    'notification_quote_viewed' => 'Klient :client zobrazil zálohovou fakturu :invoice za :amount.',
    ...
    'confirm_email_quote' => 'Jste si jistí, že chcete odeslat tuto zálohovou fakturu?',
    ...
    'quote_number_prefix' => 'Prefix čísla zálohové faktury',
    ...
    'invalid_counter' => 'Pro případný konflikt si raději nastavte prefix pro faktury nebo zálohové faktury',
    ...
    'restore_quote' => 'Obnovit zálohovou fakturu',
    ...
    'restored_quote' => 'Zálohová faktura úspěšně obnovena',
    ...
    'quote_email' => 'Email pro zálohovou fakturu',
    ...
    'email_approved' => 'Odeslat email po  <b>schválení zálohové faktury</b>',
    'notification_quote_approved_subject' => 'Zálohová faktura :invoice byla schválena  :client',
    'notification_quote_approved' => 'Klient :client schválil zálohovou fakturu :invoice na :amount.',
    ...
    'quote_no' => 'Zálohová faktura Č.',
    'recent_payments' => 'Poslední platby',
    'outstanding' => 'Neuhrazené platby',
    'invoiceOutstanding' => 'Faktury',
    'quoteOutstanding' => 'Zálohovky',
    'totalOutstanding' => 'Spolu',
    ...
    'new_recurring_quote' => 'Nová pravidelná zálohovka',
    'recurring_quote' => 'Pravidelná zálohovka',
    ...
    'quote_due_date' => 'Datum splatnosti',
    ...
    'quote_reminder_emails' => 'Připomínky emailem (zálohovky)',
    ...
    'upcoming_quotes' => 'Nadcházející zálohové faktury',
    'expired_quotes' => 'Prošlé zálohové faktury',
    ...
    'notification_quote_bounced' => 'Nebyli jsme schopni doručit zálohovou fakturu :invoice na :contact.',
    'notification_quote_bounced_subject' => 'Nebylo možné doručit zálohovou fakturu :invoice',
    'custom_invoice_link' => 'Odkaz na fakturu',
    'total_invoiced' => 'Celkem fakturováno',
    'open_balance' => 'K úhradě',
    ...
    'activity_18' => ':user vytvořil zálohovou fakturu :quote',
    'activity_19' => ':user změnil zálohovou fakturu :quote',
    'activity_20' => ':user odeslal zálohovou fakturu :quote to :contact',
    'activity_21' => ':contact zobrazil zálohovou fakturu :quote',
    'activity_22' => ':user archivoval zálohovou fakturu :quote',
    'activity_23' => ':user smazal zálohovou fakturu :quote',
    'activity_24' => ':user obnovil zálohovou fakturu :quote',
    ...
    'activity_29' => ':contact schválil zálohovou fakturu :quote (:client)',
    ...
    'quote_terms' => 'Podmínky zálohové faktury',
    'default_quote_terms' => 'Výchozí podmínky zálohové faktury',
    'default_invoice_terms' => 'Výchozí fakturační podmínky',
    'default_invoice_footer' => 'Výchozí patička faktury',
    'quote_footer' => 'Patička zálohové faktury',
    'free' => 'Zdarma',
    'quote_is_approved' => 'Úspěšně převedeno na fakturu',
    ...
    'archive_recurring_quote' => 'Archivovat pravidelnou zálohovku',
    'archived_recurring_quote' => 'Pravidelná zálohovka úspěšně archivována',
    'delete_recurring_quote' => 'Smazat pravidelnou zálohovku',
    'deleted_recurring_quote' => 'Pravidelná zálohovka smazána',
    'restore_recurring_quote' => 'Obnovit pravidelnou zálohovku',
    'restored_recurring_quote' => 'Pravidelná zálohovka obnovena',
    ...
    'next_quote_number' => 'Další číslo zálohové faktury je :number.',
    'days_before' => 'days before the',
    'days_after' => 'days after the',
    'field_due_date' => 'datum splatnosti',
    'field_invoice_date' => 'datum vystavení a zdanitelného plnení',
    'schedule' => 'Rozvrh',
    ...
    'quote_message_button' => 'Pro zobrazení zálohové faktury na :amount, klikněte na tlačítko níže.',
    ...
    'status_approved' => 'Převedeno na fakturu',
    'quote_settings' => 'Nastavení nabídek',
    'auto_convert_quote' => 'Auto Convert',
    'auto_convert_quote_help' => 'Automaticky zkonvertovat zálohovou fakturu na fakturu po schválení klientem.',
    'validate' => 'Ověřit',
    'info' => 'Info',
    ...
    'enable_recurring' => 'Zapnout pravidelnost',
    'disable_recurring' => 'Vypnout pravidelnost',
    'text' => 'Text',
...
<ul><li>Flexible business lines of credit and invoice factoring.</li></ul>',
    ...
    'mark_active' => 'Označit jako aktivní',
    ...
    'messages' => 'Messages',
    'unpaid_invoice' => 'Neuhrazena faktura',
    'paid_invoice' => 'Uhrazena faktura',
    ...
    'guide' => 'Guide',
    'gateway_fee_item' => 'Platební brána',
    'gateway_fee_description' => 'Transakční poplatek v souladu se zákonem 284/2009 Sb',
    ...
    'button' => 'Button',
    'more' => 'More',
    'edit_recurring_invoice' => 'Upravit pravidelnú fakturu',
    'edit_recurring_quote' => 'Upravit pravidelnú zálohovku',
